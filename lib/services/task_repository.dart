    ...
    return _lock.synchronized(() async {
      ...
      try {
        ...
        try {
          ...
          developer.log(
            '[TaskRepository] insertTask: Scheduling alarm for new task id=$insertedId...',
          );
          await FlutterAlarmService().scheduleForTask(taskWithId);
        } catch (e, st) {
          developer.log(
  ...
  Future<void> deleteTask(int id) async {
    return _lock.synchronized(() async {
      ...
      try {
        ...
        try {
          developer.log(
            '[TaskRepository] deleteTask: Canceling alarm for task id=$id...',
          );
          await FlutterAlarmService().cancelForTaskId(id);
        } catch (e) {
          developer.log(
